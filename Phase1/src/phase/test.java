...
public class test {
	public static void main(String[] args)  {
        File folder = new File("C:\\Users\\bava\\eclipse-workspace\\Phase1\\files");
                            ...
                            case 3:
                                ...
                                for(int a=0;a<arr1.length;a++){
                                    if(arr1[a].getName().startsWith(search)){
                                        System.out.println("File found in the directory"+folder);
                                        break;
                                      
                                    }
                                    else
                                    {
                                    	 System.out.println("File not found"+folder);
                                    }
                                    return;
